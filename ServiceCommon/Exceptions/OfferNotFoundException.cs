[assembly: Orleans.CodeGeneration.KnownType(typeof(ServiceCommon.Exceptions.OfferNotFoundException))]
namespace ServiceCommon.Exceptions
{
    ...
    public class OfferNotFoundException : Exception {
        ...
        protected OfferNotFoundException([NotNull] SerializationInfo info, StreamingContext context)
            : base(info, context) {}
    }
}